 ...
 */
public class FullscreenActivityBeforeLogin extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button launch_button = (Button) findViewById(R.id.dummy_button);
